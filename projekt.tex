...
=======
>>>>>>> 59b5edd8e92dd8f23ebf8162aac5590741680b0e
\end{acronym}
...
=======
Der Server ist ein, von Amazon gebuchter, Lightsail\footnote{https://amazonlightsail.com/} Server der über ein Linux OS mit Ubuntu als Distribution verfügt. Die auf Seite %TODO für den Server markierten Programmen sollen auf dem Server installiert werde.
\subsubsection{CMS}
Geplant ist ein CMS System auf dem Server (Drupal) mit Datenbank(MYSQL). Dabei soll für jede Komponente der Website, die auf Seite \pageref{sec:epage}
referenziert werden, ein Inhaltstyp erstellt werden.\\
...
https://goo.gl/qfjDmC
=======
\includegraphics[trim={0 10cm 0 0},height=20cm,clip]{Vorlage}
